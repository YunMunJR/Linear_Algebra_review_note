...
\begin{itemize}
    ...
    \item[\textcolor{red}{(A2), (S1)--(S4)}] \textcolor{red}{Indeed, these axioms are inherited from $V$.}

    \item[(S0)] is free of charge because of (3).

    \item[(A3)] Existence of the zero vector.

    Since $W$ is nonempty by (1), choose $\mathbf{w}\in W$.
    By (3),
    \[
    ...
    \item[(A4)] Existence of additive inverses.
